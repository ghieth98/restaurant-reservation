<x-guest-layout>
    ...
    <div
        ...
        <h1
            class="font-mono text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-400
            to-blue-500 md:text-center sm:leading-none lg:text-5xl">
        ...
        <span class="relative inline-flex w-full md:w-auto">
          <a href="#" type="button"
             class="inline-flex items-center justify-center px-6 py-2 text-base font-bold leading-6 text-white
             bg-green-600 rounded-full lg:w-full md:w-auto hover:bg-green-500 focus:outline-none">
            Book Now
          </a>
        </span>
        </div>
                ...
                <div class="w-full md:w-1/2 md:px-3">
                    <div class="w-full pb-6 space-y-4 sm:max-w-md lg:max-w-lg lg:space-y-4 lg:pr-0 md:pb-0">
                        ...
                        <div class="relative flex">
                            <a href="#"
                               class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-green-600
                                rounded-md sm:mb-0 hover:bg-green-700 sm:w-auto">
                                Read More
            ...
            <div class="flex flex-wrap items-center -mx-3">
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        ...
                        <h2
                            class="mb-4 text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r
                ...
                @foreach($specials as $special)
                    <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                        ...
                        <div class="flex items-center justify-between p-4">
                            <span class="text-xl text-green-600 relative">
                                $ {{ round($special->price / 100, 2) }}
                            </span>
                        </div>
                    </div>
                @endforeach
    ...
    <section class="pt-4 pb-12 bg-gray-800">
        ...
        <div class="grid gap-2 md:grid-cols-2 lg:grid-cols-3 ml-4">
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
                         src="https://images.unsplash.com/photo-1499714608240-22fc6ad53fb2?ixlib=rb-1.2.1&ixid=
